...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'label_connector_dialog_settings.ui'))


class LabelConnectorSettings(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(LabelConnectorSettings, self).__init__(parent)
